...
public class payload {
	public static String finetunePostPayload(String name)
	{
	...
	public static String finetunePostBodyPayload2()
	{
		String body = "{    \"model\": \"FINETUNE\",    \"cycleNumber\":1,    \"iterations\": 1,    \"trainingConfig\": {}}";
		return body;
	}
